...
public class RegisterLoginUtils {
    public static String LOGIN_URL = "http://dr.akchen.top:8080/DrWithYouWebServer/adregister";

    public static String RegistByPost(String number,String passwd)
    {
        String msg = "";
        try{
            ...
            //我们请求的数据:
            String data = "username="+ URLEncoder.encode(number, "UTF-8")+
