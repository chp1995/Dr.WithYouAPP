...
public class InfoPostUtils {
    ...
    public static String INFO_URL = "http://dr.akchen.top:8080/DrWithYouWebServer/aduser";

    public static String InfoByPost(String token,String name,String phone,String sex,String idcard)
    {
        String msg = "";
        try{
